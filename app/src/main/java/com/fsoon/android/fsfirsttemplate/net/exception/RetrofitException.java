...
public class RetrofitException extends RuntimeException {
    ...
    public static RetrofitException networkError(IOException exception) {
        return new RetrofitException(
                exception.getMessage(), null, null, Kind.NETWORK, exception, null);
    }
    ...
    public static RetrofitException failedError(String message) {
        return new RetrofitException(message, null, null, Kind.FAILED, null, null);
    }
    ...
    public enum Kind {
        ...
        UNEXPECTED,
        /**
         * An failed response from the server.
         */
        FAILED
    }
